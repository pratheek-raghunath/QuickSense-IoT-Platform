...
function Footer() {
  return (
    ...
    <footer class=" bottom-0 left-0 z-20 w-full p-4 border-t shadow md:flex md:items-center md:justify-between md:p-6 border-gray-200 bg-gray-900">
      <span class="text-sm sm:text-center text-white">© 2023 <a href="https://flowbite.com/" class="hover:underline">Kulla Gang™</a>. All Rights Reserved.
      </span>
